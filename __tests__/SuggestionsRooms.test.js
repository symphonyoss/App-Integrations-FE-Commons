...
import SuggestionsRooms from '../components/PostingLocation/SuggestionsRooms/SuggestionsRooms.jsx';
...
function setup() {
  const props = {
    ...
    loading: true,
    addStreamToInstance: () => { return {}; },
    removeStreamFromInstance: () => { return {}; },
    resetPostingLocation: () => { return {}; },
  };
